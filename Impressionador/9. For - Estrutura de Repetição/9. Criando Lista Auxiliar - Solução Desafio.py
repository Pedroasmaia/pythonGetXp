...
nivel_minimo = 50
fabricas_sem_estoque = []
for i,estoque_fabricas in enumerate(estoque):
    for qtde in estoque_fabricas:
        if qtde < nivel_minimo:
            if fabricas[i] not in fabricas_sem_estoque:
                fabricas_sem_estoque.append(fabricas[i])
print(fabricas_sem_estoque)